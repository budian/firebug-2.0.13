...
//添加到面板
    ...
    {
        //alert(NLConstant.stylePanel+","+NLConstant.checkNodeArray.length);
        //NLConstant.stylePanel.template.cascadedTag.replace({array: NLConstant.checkNodeArray}, NLConstant.stylePanel.panelNode,NLConstant.stylePanel.template);
        //alert(NLConstant.stylePanel.prototype.name);
        //alert(elt.id+","+elt.class+","+elt.name);
        var str = prompt(Locale.$STR("nl.tips_writename"),"");
		    if(str)
		    {
		    }else{
		        alert(Locale.$STR("nl.tips_required"));
		    		return;
		    }
        ...
        NLConstant.checkNodeArray.push(itemObject);
    		NLConstant.stylePanel.prototype.template.updateTable(itemObject);
    },
        ...
        items.push(
            {
                id: "fbaddNode",
                label: "nl.add_node",
                tooltiptext: "nl.add_node",
                command: Obj.bindFixed(this.addNode, this, elt)
            });
